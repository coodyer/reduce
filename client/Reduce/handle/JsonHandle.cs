...
namespace Reduce.handle
{
    class JsonHandle
    {
        ...
        private static Object jsonSerializerSettings = null;
        ...
        public static bool init()
        {
            ...
            try
            {
                if (jsonHandleType == null)
                {
                    ...
                    Type jsonSerializerSettingsType = assembly.GetType("Newtonsoft.Json.JsonSerializerSettings");
                    jsonSerializerSettings = Activator.CreateInstance(jsonSerializerSettingsType);
                    Object camelCasePropertyNamesContractResolver = Activator.CreateInstance(assembly.GetType("Newtonsoft.Json.Serialization.CamelCasePropertyNamesContractResolver"));
                  
                    FieldInfo field = jsonSerializerSettingsType.GetField("<ContractResolver>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance);
                    field.SetValue(jsonSerializerSettings, camelCasePropertyNamesContractResolver);
                    return true;
                }
                return false;
            }
        ...
        public static string toJson(object value)
        {
            ...
            {
                init();
                return (string)jsonHandleType.InvokeMember("SerializeObject", BindingFlags.Default | BindingFlags.InvokeMethod, null, null, new object[] { value, jsonSerializerSettings });
            }
            catch
            {
                return "";
        ...
        public static T toBean<T>(string value)
        {
            init();
            return (T)jsonHandleType.InvokeMember("DeserializeObject", BindingFlags.Default | BindingFlags.InvokeMethod, null, null, new object[] { value, typeof(T), null });
        }
